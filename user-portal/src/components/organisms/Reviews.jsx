...
function Reviews() {
  ...
  let values = {
    ...
    comment: comment,
    rating: star,
    customerName: username ? username.firstName : "guest",
  };
  ...
  return (
    <div>
      ...
      <InputTag
        ...
        className="mb-2 mr-2"
        onChange={(e) => userReview(e)}
      />
      <Button
        type="submit"
        className="submit-btn btn btn-warning text-uppercase text-white mb-1"
        buttonText="submit"
        onClick={() => {
          submit(values);
          islogin();
              ...
              return (
                <div className="row" key={index}>
                  ...
                  <div className="col-11">
                    <CustomerReviews
                      review={rev}
                      name={username ? username.firstName : "guest"}
                      func={() => {
                        deleteReview(postedReview?.[index]?._id);
                      }}
                    />
                  </div>
                </div>
      ...
      {showAll && review?.length > 5 ? (
        <Atag
          className="review-link font-weight-bold"
          aText="View less"
