    ...
    return (
        <>
            ...
            <div className="sort-options d-flex align-items-center">
                ...
                <div className="lowToHigh font-weight-bold sort-option ml-5"  id="low-to-high">Price--Low to High</div>
                <div className="highToLow font-weight-bold sort-option ml-5"  id="high-to-low">Price--High to Low</div>
                <div className="whatsNew font-weight-bold sort-option ml-5"  id="whats-new">what's New</div>
            </div>
        </>
    )
}
