...
function ProductCard({ product ,onClick}) {
    ...
    return (
        <div className={`${viewOption==='list'?'col-12 m-2':' col-xl-3 col-lg-4 col-md-6 col-6 d-flex justify-content-center align-items-center mt-2'} card-div`} id={product._id} onClick={onClick}>
